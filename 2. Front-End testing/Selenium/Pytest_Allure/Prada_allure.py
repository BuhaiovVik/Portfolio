...
@allure.testcase("fept_001")
@pytest.mark.positive
def test01_fept_001_max(setup):
...
@allure.title("New Address")
@allure.tag("Positive")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("fept_002")
@pytest.mark.positive
def test02_fept_002_max(setup):
...
@allure.title("Address change")
@allure.tag("Positive")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("fept_003")
@pytest.mark.positive
def test03_fept_003_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.title("Buy bags")
@allure.tag("Positive")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("fept_004")
@pytest.mark.positive
def test04_fept_004_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
...
@allure.tag("Positive")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("fept_005")
@pytest.mark.positive
def test05_fept_005_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.title("Buy perfume")
@allure.tag("Positive")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("fept_006")
@pytest.mark.positive
def test06_fept_006_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.title("Payment")
@allure.tag("Positive")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("fept_007")
@pytest.mark.positive
def test07_fept_007_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.tag("Positive")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("fept_008")
@pytest.mark.positive
def test08_fept_008_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.title("Login with wrond data")
@allure.tag("Negative")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("feng_001")
@pytest.mark.negative
def test09_feng_001_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.tag("Negative")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("feng_002")
@pytest.mark.negative
def test10_feng_002_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
    wait.until(EC.element_to_be_clickable((By.XPATH, "//*[text() = 'ACCEPT ALL']")))
    driver.find_element(By.XPATH, "//*[text() = 'ACCEPT ALL']").click()
...
@allure.title("Payment with unvalid card")
@allure.tag("Negative")
@allure.severity(allure.severity_level.CRITICAL)
@allure.testcase("feng_003")
@pytest.mark.negative
def test11_feng_003_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.testcase("feng_004")
@pytest.mark.negative
def test12_feng_004_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
...
@allure.tag("Negative")
@allure.severity(allure.severity_level.MINOR)
@allure.testcase("feng_005")
@pytest.mark.negative
def test13_feng_005_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.tag("Negative")
@allure.severity(allure.severity_level.MINOR)
@allure.testcase("feng_006")
@pytest.mark.negative
def test14_feng_006_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.tag("Negative")
@allure.severity(allure.severity_level.MINOR)
@allure.testcase("feng_007")
@pytest.mark.negative
def test15_feng_007_max(setup):
    driver.get("https://www.prada.com/us/en/login-register.html")
    wait = WebDriverWait(driver, 10)
...
@allure.tag("Boundary")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("febd_001")
@pytest.mark.boundary
def test17_febd_001_max(setup):
    driver.get("https://internxt.com/temporary-email")
    wait = WebDriverWait(driver, 50)
...
@allure.tag("Boundary")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("febd_002")
@pytest.mark.boundary
def test18_febd_002_max(setup):
    driver.get("https://internxt.com/temporary-email")
    wait = WebDriverWait(driver, 50)
...
@allure.tag("Boundary")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("febd_003")
@pytest.mark.boundary
def test19_febd_003_max(setup):
    driver.get("https://internxt.com/temporary-email")
    wait = WebDriverWait(driver, 50)
...
@allure.tag("Boundary")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("febd_004")
@pytest.mark.boundary
def test20_febd_004_max(setup):
    driver.get("https://internxt.com/temporary-email")
    wait = WebDriverWait(driver, 50)
...
@allure.tag("Boundary")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("febd_005")
@pytest.mark.boundary
def test21_febd_005_max(setup):
    driver.get("https://internxt.com/temporary-email")
    wait = WebDriverWait(driver, 50)
...
@allure.tag("Boundary")
@allure.severity(allure.severity_level.NORMAL)
@allure.testcase("febd_006")
@pytest.mark.boundary
def test22_febd_006_max(setup):
    driver.get("https://internxt.com/temporary-email")
    wait = WebDriverWait(driver, 50)
